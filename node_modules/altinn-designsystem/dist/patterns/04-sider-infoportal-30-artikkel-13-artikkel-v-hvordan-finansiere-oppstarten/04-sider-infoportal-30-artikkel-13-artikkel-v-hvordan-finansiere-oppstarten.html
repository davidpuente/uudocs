      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-8 offset-lg-2 a-text epi-wysiwyg pt-2 pt-lg-3">
            ...
            <!-- START: 00-atomer-07-tekst-03-avsnitt -->
            <p class="">En viktig avklaring er å finne ut hva og hvor mye kapital du vil trenge for å finansiere oppstarten. Beløpet kommer du fram til ved å lage gode oppstartsbudsjetter (link til tekst om oppstartsbudsjetter). I oppstartbudsjettene beregner du
              hva som er nødvendig av utstyr, andre oppstartskostnader og eventuelt driftskapital for å dekke løpende utgifter i tiden før du begynner å få inntekter.</p>
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Artikkel V Hvordan Finansiere Oppstarten",
      "patternPartial": "sider-infoportal-artikkel-v-hvordan-finansiere-oppstarten",
