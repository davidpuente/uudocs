...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-51-omraadeside -->
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1">
            ...
            <p class="a-leadText " id="leadText">I a-meldingen gir du opplysninger om ansattes inntekt, arbeidsforhold og forskuddstrekk i tillegg til arbeidsgiveravgift. Opplysningene leverer du til NAV, Skatteetaten og Statistisk sentralbyrå i en månedlig a-melding.</p>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 a-text epi-wysiwyg">
            ...
            <p class=""> Du sender a-meldingen fra et lønnssystem. Opplysningspliktige med få ansatte og uten lønnssystem kan i stedet bruke et skjema i Altinn.</p>

            <!-- END: 00-atomer-07-tekst-03-avsnitt -->


            <div class="a-gridMinusOneCol pt-2">
              ...
              <div class="a-iconText a-iconText-shadow a-iconText-background a-iconText-background--white ">
                ...
                <div class="a-iconText-text">
                  ...
                  <!-- START: 00-atomer-02-lenker-00-link -->
                  <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-11-artikkel-skjema-v-amelding/04-sider-infoportal-35-skjemaartikkel-11-artikkel-skjema-v-amelding.html" class="false " data-parent="#accordion">
  A-melding – registrere direkte i Altinn
                  ...
                  <span class="a-formCode">(A-01)</span>

                  <p class="mt-1 mb-0 ">For virksomheter med med 1 - 8 ansatte uten eget lønnssystem.</p>
                </div>
              </div>
            ...
            <div class="a-gridMinusOneCol pt-2">
              ...
              <div class="a-iconText a-iconText-shadow a-iconText-background a-iconText-background--white ">
                ...
                <div class="a-iconText-text">
                  ...
                  <!-- START: 00-atomer-02-lenker-00-link -->
                  <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-12-artikkel-skjema-v-amelding-a02/04-sider-infoportal-35-skjemaartikkel-12-artikkel-skjema-v-amelding-a02.html" class="false " data-parent="#accordion">
  A-melding - sende fra system
                  ...
                  <span class="a-formCode">(A-02)</span>

                  <p class="mt-1 mb-0 ">Tjenesten er for virksomheter med lønnssystem eller annet system som er delvis integrert mot Altinn. Har du et system som er fullt integrert, sender du a-melding direkte i systemet.</p>
                </div>
              </div>
            ...
            <div class="a-gridMinusOneCol pt-2">
              ...
              <div class="a-iconText a-iconText-shadow a-iconText-background a-iconText-background--white ">
                ...
                <div class="a-iconText-text">
                  ...
                  <!-- START: 00-atomer-02-lenker-00-link -->
                  <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-14-artikkel-skjema-v-amelding-a04/04-sider-infoportal-35-skjemaartikkel-14-artikkel-skjema-v-amelding-a04.html" class="false " data-parent="#accordion">
  A-melding – melding om lønnet arbeid i hjemmet
                  ...
                  <span class="a-formCode">(A-04)</span>

                  <p class="mt-1 mb-0 ">Skjemaet er for privatpersoner som betaler lønn til ansatte i egen bolig eller fritidseiendom.</p>
                </div>
              </div>
            ...
            <div class="a-gridMinusOneCol pt-2">
              ...
              <div class="a-iconText a-iconText-shadow a-iconText-background a-iconText-background--white ">
                ...
                <div class="a-iconText-text">
                  ...
                  <!-- START: 00-atomer-02-lenker-00-link -->
                  <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-15-artikkel-skjema-v-amelding-a05/04-sider-infoportal-35-skjemaartikkel-15-artikkel-skjema-v-amelding-a05.html" class="false " data-parent="#accordion">
  A-melding - for veldedige og almennyttige organisasjoner
                  ...
                  <span class="a-formCode">(A-05)</span>

                  <p class="mt-1 mb-0 ">Skjemaet er for veldedige organisasjoner med lønnsutgifter som ikke inngår i næringsvirksomhet.</p>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 mt-2">
            <h2>Om A-ordningen</h2>
    ...
    <span class="primary-collapse-text">
      Hvem må sende a-melding
                ...
                <div id="accordionSmallItem1" class="a-collapseContent collapse a-text" role="tabpanel" aria-labelledby="collapseTitle1">
                  <p>Alle virksomheter som betaler ut lønn og har ansatte skal levere a-melding. Dette gjelder:</p>
                  <ul>
                    <li>Arbeidsgivere</li>
                    <li>Pensjonsselskap</li>
                  </ul>
                  <p>MERK: Utenlandske arbeidsgivere som har rapporteringsplikt om kontrakts- og arbeidsforhold (skjema RF-1199) skal ikke rapportere arbeidsforhold. De må imidlertid sende a-melding for utbetalt lønn og andre ytelser, fradrag, forskuddstrekk
                    og arbeidsgiveravgift. </p>
                  <p>Opplysningsplikten er lovfestet i <a href="https://lovdata.no/dokument/NL/lov/2012-06-22-43">a-opplysningsloven</a>. </p>
                </div>
   ...
   <span class="a-dropdownArrow"></span> 
    ...
    <span class="primary-collapse-text">
      Hvem må <i>ikke</i> sende a-melding
    </span>
</a>
                ...
                <div id="accordionSmallItem2" class="a-collapseContent collapse a-text" role="tabpanel" aria-labelledby="collapseTitle2">
                  Enkeltpersonforetak uten ansatte skal ikke skal levere a-melding.
                </div>
    ...
    <span class="primary-collapse-text">
      Hvis du ikke leverer
                ...
                <div id="accordionSmallItem3" class="a-collapseContent collapse a-text" role="tabpanel" aria-labelledby="collapseTitle3">
                  <p>Manglende rapportering kan få konsekvenser for dine ansatte i inntekstmottakerens selvangivelse eller i utbetalinger fra NAV. Det er derfor svært viktig at du rapporterer riktig og innen frist. Husk at du skal rapportere arbeidsforhold
                    selv om du ikke utbetaler lønn. </p>
                  <p>Hvis du ikke leverer a-melding eller leverer med feil, kan du få tvangsmulkt. Du må rette opp i feilene for at mulkten skal opphøre. </p>
                </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 py-4">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-51-omraadeside -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Omraadeside",
      "patternPartial": "sider-infoportal-omraadeside",
      "patternState": "specification",
