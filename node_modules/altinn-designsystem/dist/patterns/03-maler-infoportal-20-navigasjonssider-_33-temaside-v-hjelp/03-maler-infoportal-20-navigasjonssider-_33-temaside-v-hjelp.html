...
<body class="a-bgWhite" id="top">
  <!-- START: 03-maler-infoportal-20-navigasjonssider-_33-temaside-v-hjelp -->
  <div class="a-page">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6 offset-lg-3 a-articleSearch">
          ...
          <div class="form-group a-form-group  a-form-group-large  ">
            ...
            <label class="a-form-label  sr-only  " for="help-search2">Søk etter guider og annet innhold</label>

            <div class="a-form-group-items input-group   ">

              <input class="form-control  
         a-hasButton  " type="text" placeholder="Søk etter guider og annet innhold" name="input-field" data-val="true" id="help-search2">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 03-maler-infoportal-20-navigasjonssider-_33-temaside-v-hjelp -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternLineagesR": [{
        "lineagePattern": "sider-infoportal-temaside-v-hjelp-innlogging",
        "lineagePath": "../../patterns/04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging\\04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging.html"
      }],
      "lineageR": [{
        "lineagePattern": "sider-infoportal-temaside-v-hjelp-innlogging",
        "lineagePath": "../../patterns/04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging\\04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging.html"
      ...
      "patternName": "Temaside V Hjelp",
      "patternPartial": "maler-infoportal-temaside-v-hjelp",
