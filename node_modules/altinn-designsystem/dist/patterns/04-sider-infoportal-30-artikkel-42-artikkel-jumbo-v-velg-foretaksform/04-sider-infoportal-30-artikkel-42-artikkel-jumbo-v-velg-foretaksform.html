              ...
              <div class="row">
                <div class="a-compare-container col-6 col-md col-max-4">
                  ...
                  <div class="a-compare-element ">
                    ...
                    <p>Er du alene om å skulle starte foretak? Enkeltpersonforetak er en selvstendig næringsvirksomhet drevet under fullt personlig ansvar av en person. Aktiviteter som ansees som rene engangshendelser eller hobbyvirksomhet defineres ikke
                      som næringsvirksomhet.</p>
                    <strong>
      <!-- START: 00-atomer-02-lenker-00-link -->
<a
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Artikkel Jumbo V Velg Foretaksform",
      "patternPartial": "sider-infoportal-artikkel-jumbo-v-velg-foretaksform",
