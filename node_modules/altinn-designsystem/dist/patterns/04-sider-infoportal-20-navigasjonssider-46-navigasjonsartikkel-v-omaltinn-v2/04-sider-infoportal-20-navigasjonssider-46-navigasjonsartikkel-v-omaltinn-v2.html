...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-46-navigasjonsartikkel-v-omaltinn-v2 -->
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
    ...
    <section id="content" tabindex="-1">
      ...
      <div class="container-fluid">
        ...
        <div class="jumbotron jumbotron-fluid a-jumbotron a-jumbotron-bottom a-jumbotron--autoHeight a-jumbotron-dark py-6" style="background-color: #022F51; ">
          <div class="container">
            <div class="row">
              <div class="  col-md-12  col-lg-10 offset-lg-1 col-xl-10 offset-xl-1">
                ...
                <div class="a-list-container pb-3">
                  <ul class="a-list   a-list-noIcon a-list-large a-list-2col ">
                    <li class="a-dotted a-clickable a-list-hasRowLink">
                      <a href="/patterns/04-sider-infoportal-30-artikkel-20-artikkel-v-hvemhvahvordan/04-sider-infoportal-30-artikkel-20-artikkel-v-hvemhvahvordan.html" class="a-list-rowLink">
                        <div class="row ">
                          <div class="col">
                            <!-- START: 01-molekyler-05-lister-_00-liste-innhold -->
                    ...
                    <li class="a-dotted a-clickable a-list-hasRowLink">
                      <a href="/patterns/04-sider-infoportal-20-navigasjonssider-60-arkiv-v-nyhetsarkiv/04-sider-infoportal-20-navigasjonssider-60-arkiv-v-nyhetsarkiv.html" class="a-list-rowLink">
                        <div class="row ">
                          <div class="col">
                            <!-- START: 01-molekyler-05-lister-_00-liste-innhold -->
                    ...
                    <li class="a-dotted a-clickable a-list-hasRowLink">
                      <a href="/patterns/04-sider-infoportal-20-navigasjonssider-61-arkiv-v-driftsarkiv/04-sider-infoportal-20-navigasjonssider-61-arkiv-v-driftsarkiv.html" class="a-list-rowLink">
                        <div class="row ">
                          <div class="col">
                            <!-- START: 01-molekyler-05-lister-_00-liste-innhold -->
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6 offset-lg-3 pb-3">
            ...
            <div class="a-card a-cardImage mb-2 mb-md-6">
              ...
              <div class="a-cardImage-text">
                <h2>Altinn brukerservice</h2>
                <p>For veiledning i bruk av altinn.no ta kontakt med vår brukerservice. Telefonen er åpen 0800-1530, mandag-fredag.</p>
            ...
            <div class="a-card a-cardImage mb-2 mb-md-6">
              ...
              <div class="a-cardImage-text">
                <h2>Pressevakt</h2>
                <p>Ta kontakt på sms. (Dette er kun for presse og media. For brukerhenvendelser benytt Altinn brukerservice)</p>
            ...
            <div class="a-card a-cardImage mb-2 mb-md-6">
              ...
              <div class="a-cardImage-text">
                <h2>Følg oss</h2>
                <p>Altinn er på Facebook, Twitter og Linkedin. Har du lyst til å holde deg oppdatert på hva Altinn jobber med, følg oss gjerne.</p>
                ...
                <a href="#" class="a-linkIcon ">
                  <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                  <i class="ai ai-nw ai-nw-pr ai-facebook   "></i>
    ...
    Facebook
                ...
                <a href="#" class="a-linkIcon ">
                  <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                  <i class="ai ai-nw ai-nw-pr ai-twitter   "></i>
    ...
    Twitter
                ...
                <a href="#" class="a-linkIcon ">
                  <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                  <i class="ai ai-nw ai-nw-pr ai-linkedin   "></i>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-46-navigasjonsartikkel-v-omaltinn-v2 -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Navigasjonsartikkel V Omaltinn V2",
      "patternPartial": "sider-infoportal-navigasjonsartikkel-v-omaltinn-v2",
