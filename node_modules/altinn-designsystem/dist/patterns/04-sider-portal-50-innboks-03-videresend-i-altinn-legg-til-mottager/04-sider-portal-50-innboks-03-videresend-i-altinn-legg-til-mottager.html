...
<body class="" id="top">
  <!-- START: 04-sider-portal-50-innboks-03-videresend-i-altinn-legg-til-mottager -->
                        ...
                        <form data-toggle="validator" data-disable="true">
                          <div class="row">
                            <div class="col-12 col-lg-7">
                              <h3 class="a-h4">Legg til person du vil videresende til</h3>
                              ...
                              <div class="mt-1">
                                ...
                                <div class="form-group a-form-group  ">
                                  ...
                                  <div class="a-form-group-items input-group   ">
                                    ...
                                    <input class="form-control  
         " type="text" placeholder="Etternavn" name="input-field" data-val="true" id="text-etternavn" required data-search-algorithm="show-and-highlight" data-search-target="employee-table">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-portal-50-innboks-03-videresend-i-altinn-legg-til-mottager -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Videresend I Altinn Legg Til Mottager",
      "patternPartial": "sider-portal-videresend-i-altinn-legg-til-mottager",
