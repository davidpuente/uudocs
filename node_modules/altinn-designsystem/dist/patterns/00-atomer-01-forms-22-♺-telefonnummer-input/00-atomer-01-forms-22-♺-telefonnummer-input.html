  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Brukes når telefonnummer skal fylles inn. Feimelding kommer umiddelbart dersom bruker forsøker å skrive noe annet en siffer.</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "forms"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Telefonnummer Input",
      "patternPartial": "atomer-♺-telefonnummer-input",
