...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-50-kolonnenavigasjon-v-skjemaoversikt-etater -->
        ...
        <div class="row a-containerColnav-top">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3" data-switchUrl1="getcategory" data-switchUrl2="getprovider" data-switchEndpoint="/data/">
            ...
            <fieldset class="switch-container">
              ...
              <div class="radio">
                <input class="sr-only" type="radio" id="atom-switch-cb2" name="js-switchForm" checked>
                ...
                <li>
                  ...
                  <ul class="a-colnav a-colnav-vertical a-colnav-secondLevel">
                    <li>
                      ...
                      <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-11-artikkel-skjema-v-amelding/04-sider-infoportal-35-skjemaartikkel-11-artikkel-skjema-v-amelding.html" class="a-colnav-item-second a-js-colnavLinkAlt">
                        <h4>A-melding</h4>
                      </a>
                    ...
                    <li>
                      <a href="#" class="a-colnav-item-second a-js-colnavLink">
                        <h3>Egenmeldt sykefravær</h3>
                      </a>
                      <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-53-artikkel-skjema-v-egenmeldt-sykefravaer/04-sider-infoportal-35-skjemaartikkel-53-artikkel-skjema-v-egenmeldt-sykefravaer.html" class="a-colnav-item-second a-js-colnavLinkAlt">
                    ...
                    <li>
                      <a href="#" class="a-colnav-item-second a-js-colnavLink">
                        <h3>Selskapsoppgave for deltakerliknet selskap</h3>
                      </a>
                      <a href="/patterns/04-sider-infoportal-35-skjemaartikkel-54-artikkel-skjema-v-selskapsoppgave-for-deltakerliknet-selskap/04-sider-infoportal-35-skjemaartikkel-54-artikkel-skjema-v-selskapsoppgave-for-deltakerliknet-selskap.html" class="a-colnav-item-second a-js-colnavLinkAlt">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-50-kolonnenavigasjon-v-skjemaoversikt-etater -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Kolonnenavigasjon V Skjemaoversikt Etater",
      "patternPartial": "sider-infoportal-kolonnenavigasjon-v-skjemaoversikt-etater",
