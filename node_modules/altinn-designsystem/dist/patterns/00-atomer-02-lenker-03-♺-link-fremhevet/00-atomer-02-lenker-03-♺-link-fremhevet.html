  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Denne lenken kan brukes på utvalgte steder for å oppfordre brukeren til en oppgave eller henvise til en oversikt. For eksempel i slutten av lister, etc.</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "lenker"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Link Fremhevet",
      "patternPartial": "atomer-♺-link-fremhevet",
