...
<body class="a-bgBlueLight" id="top">
  <!-- START: 04-sider-portal-50-innboks-_30-innboks-frister -->
  <!-- START: 03-maler-portal-50-innboks-_30-innboks-frister -->
  <div class="a-page">
    ...
    <span class="a-btn-icon-text ">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 mt-3  a-p-x9-xl">
          ...
          <p>
            Her finner du en oversikt over frister og oppgavplikter registrert på ditt enkeltpersonforetak. Vær oppmerksom på at det finnes noen rapporteringsplikter, hvor du selv må følge med og sende inn. Her finner du en <a href="#">oversikt over potensielle plikter uten frister</a>.
          </p>

          <!-- START: 00-atomer-07-tekst-09-sidetittel -->
          <h1 class="a-fontBold a-pageTitle a-h2 a-fontReg mt-4">
            Haster!
                ...
                <a href="#" data-toggle="collapse" data-target="#accordionItem1" aria-expanded="false" aria-controls="accordionItem1" data-parent="#accordion">
                  ...
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    <div class="a-iconText-icon ">
                      ...
                      <div class="a-date a-bgRed">
                        <div class="a-date-day">5</div>
                        <div class="a-date-month">sept</div>
                      </div>
                    ...
                    <div class="a-iconText-text">
                      ...
                      <span class="a-iconText-text-large">Det var en feil på A-meldingen for september 2016 (A03)  </span>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 mb-3 ">
          ...
          <!-- START: 02-organismer-50-ekspanderbart-panel-40-ekspanderbart-panel-trekkspill JS doc: toggleInstant.js -->
          <div id="accordion2" class="a-panelAccordion" role="tablist" aria-multiselectable="true">
            <!-- START: 02-organismer-50-ekspanderbart-panel-30-ekspanderbart-panel JS doc: togglePanel.js -->
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
            ...
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
                <a href="#" data-toggle="collapse" data-target="#accordionItem3" aria-expanded="false" aria-controls="accordionItem3" data-parent="#accordion">
                  <!-- START: 01-molekyler-00-tekst-30-ikon-tekst -->
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    <div class="a-iconText-icon ">
                      <!-- START: 00-atomer-07-tekst-06-dato -->
              ...
              <div class="a-collapsePanel-body collapse" role="tabpanel" aria-labelledby="" id="accordionItem3">
                <div class="card-block a-text a-collapsePanel-body-content a-collapseContent-delay">
                  Meldingen kommer her lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cumque maxime, quam commodi doloremque adipisci deserunt atque non unde rem blanditiis quos veritatis suscipit, omnis animi labore nobis delectus eaque.
                </div>
              </div>
            ...
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
                <a href="#" data-toggle="collapse" data-target="#accordionItem4" aria-expanded="false" aria-controls="accordionItem4" data-parent="#accordion">
                  <!-- START: 01-molekyler-00-tekst-30-ikon-tekst -->
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    <div class="a-iconText-icon ">
                      <!-- START: 00-atomer-07-tekst-06-dato -->
              ...
              <div class="a-collapsePanel-body collapse" role="tabpanel" aria-labelledby="" id="accordionItem4">
                <div class="card-block a-text a-collapsePanel-body-content a-collapseContent-delay">
                  Meldingen kommer her lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cumque maxime, quam commodi doloremque adipisci deserunt atque non unde rem blanditiis quos veritatis suscipit, omnis animi labore nobis delectus eaque.
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 mb-3 ">
          ...
          <!-- START: 02-organismer-50-ekspanderbart-panel-40-ekspanderbart-panel-trekkspill JS doc: toggleInstant.js -->
          <div id="accordion3" class="a-panelAccordion" role="tablist" aria-multiselectable="true">
            <!-- START: 02-organismer-50-ekspanderbart-panel-30-ekspanderbart-panel JS doc: togglePanel.js -->
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
                <a href="#" data-toggle="collapse" data-target="#accordionItem5" aria-expanded="false" aria-controls="accordionItem5" data-parent="#accordion">
                  <!-- START: 01-molekyler-00-tekst-30-ikon-tekst -->
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    <div class="a-iconText-icon ">
                      <!-- START: 00-atomer-07-tekst-06-dato -->
                    ...
                    <div class="a-iconText-text">
                      <span class="a-iconText-text-small">A-ordningen</span>
                      <span class="a-iconText-text-large">A-meldingen  for november 2016 — Mangelfull rapportering (A03)   </span>
                    </div>
                  </div>
              ...
              <div class="a-collapsePanel-body collapse" role="tabpanel" aria-labelledby="" id="accordionItem5">
                <div class="card-block a-text a-collapsePanel-body-content a-collapseContent-delay">
                  Meldingen kommer her lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cumque maxime, quam commodi doloremque adipisci deserunt atque non unde rem blanditiis quos veritatis suscipit, omnis animi labore nobis delectus eaque.
                </div>
              </div>
            ...
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
                <a href="#" data-toggle="collapse" data-target="#accordionItem6" aria-expanded="false" aria-controls="accordionItem6" data-parent="#accordion">
                  <!-- START: 01-molekyler-00-tekst-30-ikon-tekst -->
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    <div class="a-iconText-icon ">
                      <!-- START: 00-atomer-07-tekst-06-dato -->
              ...
              <div class="a-collapsePanel-body collapse" role="tabpanel" aria-labelledby="" id="accordionItem6">
                <div class="card-block a-text a-collapsePanel-body-content a-collapseContent-delay">
                  Meldingen kommer her lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus cumque maxime, quam commodi doloremque adipisci deserunt atque non unde rem blanditiis quos veritatis suscipit, omnis animi labore nobis delectus eaque.
                </div>
              </div>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 03-maler-portal-50-innboks-_30-innboks-frister -->


  <!-- END: 04-sider-portal-50-innboks-_30-innboks-frister -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Innboks Frister",
      "patternPartial": "sider-portal-innboks-frister",
