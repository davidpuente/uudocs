  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Når flere knapper skal vises ved siden av hverandre, kan de legges i klassen a-btn-group. Dette gjelder f.eks i tilfeller der brukeren har flere valg/handlingsmuligheter.</p>\n",
      "patternBreadcrumb": {
        "patternType": "molekyler",
        "patternSubtype": "grupper"
      },
      "patternExtension": "mustache",
      "patternName": "Grupperte Knapper",
      "patternPartial": "molekyler-grupperte-knapper",
