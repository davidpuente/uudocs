...
<div id="viewall-sider-portal-aktorvalg" class="sg-pattern-category">
  <h2 class="sg-pattern-category-title"><a href="../../patterns/04-sider-portal-01-aktorvalg\index.html" class="patternLink" data-patternpartial="viewall-sider-portal-aktorvalg">aktorvalg</a></h2>
...
<div id="sider-portal-aktorvalg" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-portal-01-aktorvalg-10-aktorvalg\04-sider-portal-01-aktorvalg-10-aktorvalg.html" class="patternLink" data-patternpartial="sider-portal-aktorvalg" title="Link to Pattern">
          Aktorvalg
            <span class="sg-pattern-state needsrevalidation">needsrevalidation</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-portal-aktorvalg" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-portal-aktorvalg" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-portal-aktorvalg">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-portal-01-aktorvalg-10-aktorvalg -->
      ...
      <p>
        ...
        <span lang="en">Information about other languages.</span>
          ...
          <li class="nav-item">
            ...
            <button disabled class="nav-link dropdown-toggle a-personSwitcher " type="button" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="col-sm-12 pb-3">
        ...
        <div class="pt-1 ">
          ...
          <div class="a-listWithSubLevels a-shadow">
            ...
            <button type="button" class="a-btn-shadow-large a-btn a-btn-shadow a-btn-icon  " onclick="location.href='link.sider-innboks';">
    ...
    <span class="a-btn-icon-text a-fontBold">
      Pettersen foto
        <span class="a-btn-icon-text-second a-fontReg a-fontSizeXS">org.nr. 893 234 789</span>
          ...
          <div class="a-listWithSubLevels a-shadow">
            <!-- START: 00-atomer-03-knapper-25-knapp-ikon-tekst -->
            <button type="button" class="a-btn a-btn-shadow-large disabled a-btn-shadow a-btn-icon  " onclick="location.href='link.sider-innboks';" disabled>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
    ...
    6 underenheter
          ...
          <div class="a-listWithSubLevels a-shadow">
            <!-- START: 00-atomer-03-knapper-25-knapp-ikon-tekst -->
            <button type="button" class="a-btn-shadow-large a-btn a-btn-shadow a-btn-icon a-bgGreyLight  " onclick="location.href='link.sider-innboks';">
    ...
    <span class="a-btn-icon-text a-fontBold">
      Pettersen Tallknuser (slettet)
        <span class="a-btn-icon-text-second a-fontReg a-fontSizeXS">org.nr. 893 234 789</span>
          ...
          <div class="a-listWithSubLevels a-shadow">
            <!-- START: 00-atomer-03-knapper-25-knapp-ikon-tekst -->
            <button type="button" class="a-btn a-btn-shadow a-btn-shadow-large a-btn-icon  " onclick="location.href='link.sider-innboks';">
    ...
    <span class="a-btn-icon-text a-fontBold">
      Pettersen Bygg
        <span class="a-btn-icon-text-second a-fontReg a-fontSizeXS">org.nr. 893 234 789</span>
          ...
          <button onclick="location.href='link.sider-aktorvalg'" type="button" class="a-btn a-btn-action a-fullWidthBtn">
...
<!-- END: 04-sider-portal-01-aktorvalg-10-aktorvalg -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-portal-aktorvalg" class="sg-pattern-data">
    
  </script>
</div><!--end .sg-pattern-->
<div id="sider-portal-aktorvalg-forste-gang" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang\04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang.html" class="patternLink" data-patternpartial="sider-portal-aktorvalg-forste-gang" title="Link to Pattern">
          Aktorvalg Forste Gang
            <span class="sg-pattern-state needsrevalidation">needsrevalidation</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-portal-aktorvalg-forste-gang" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-portal-aktorvalg-forste-gang" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-portal-aktorvalg-forste-gang">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang -->
<!-- START: 03-maler-portal-01-aktorvalg-10-aktorvalg -->
<!-- START: 02-organismer-01-globale-00-header -->
<!-- Skip to main content -->
<nav class="a-jumpnav">
...
<div class="container-fluid a-login-container a-bgWhite a-shadow" id="content" tabindex="-1">
  <div class="container a-triangleShadow">
    <div class="row px-2 px-md-1">
      <div class="col-12 col-lg-4 mb-1">
        <h1 class="a-h2 d-inline">Velg profil</h1>
  ...
  Logg ut
    ...
    <div class="row">
      <div class="col-sm-12 pb-3">
        ...
        <div class="a-listWithSubLevels a-shadow">
          <!-- START: 00-atomer-03-knapper-25-knapp-ikon-tekst -->
          <button type="button" class="a-btn-shadow-large a-btn a-btn-shadow a-btn-icon a-bgGreyLight  " onclick="location.href='link.sider-enkel-innboks';">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
    ...
    <div class="row">
      <div class="col">
        <h2 class="a-h4 px-lg-3">Alle dine profiler:</h2>
      </div>

      <div class="col-auto">
        <!-- START: 00-atomer-02-lenker-36-link-ikon -->
        <a href="#" class="a-linkIcon pr-1 pr-lg-3 ">
          <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
          <i class="ai ai-sm ai-search   "></i>


          <!-- END: 00-atomer-09-bilder-og-media-15-ikon -->

          <span class="hidden-md-down a-fontSizeXS a-link--underline">
    Søk i flere profiler
  </span>
        </a>
...
<!-- END: 04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-portal-aktorvalg-forste-gang" class="sg-pattern-data">
    
  </script>
</div><!--end .sg-pattern-->
<div id="sider-portal-aktorvalg-forste-gang-enkel" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang-enkel\04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang-enkel.html" class="patternLink" data-patternpartial="sider-portal-aktorvalg-forste-gang-enkel" title="Link to Pattern">
          Aktorvalg Forste Gang Enkel
            <span class="sg-pattern-state needsrevalidation">needsrevalidation</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-portal-aktorvalg-forste-gang-enkel" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-portal-aktorvalg-forste-gang-enkel" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-portal-aktorvalg-forste-gang-enkel">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang-enkel -->
<!-- START: 03-maler-portal-01-aktorvalg-10-aktorvalg -->
<!-- START: 02-organismer-01-globale-00-header -->
<!-- Skip to main content -->
<nav class="a-jumpnav">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 pb-3">
        ...
        <div class="pt-1 ">
          ...
          <div class="a-listWithSubLevels a-shadow">
            <!-- START: 00-atomer-03-knapper-25-knapp-ikon-tekst -->
            <button type="button" class="a-btn-shadow-large a-btn a-btn-shadow a-btn-icon  " onclick="location.href='link.sider-kompakt-innboks';">
...
<!-- END: 04-sider-portal-01-aktorvalg-10-aktorvalg-forste-gang-enkel -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-portal-aktorvalg-forste-gang-enkel" class="sg-pattern-data">
  ...
  {"patternPartial":"viewall-sider-portal-aktorvalg"}
</script>
