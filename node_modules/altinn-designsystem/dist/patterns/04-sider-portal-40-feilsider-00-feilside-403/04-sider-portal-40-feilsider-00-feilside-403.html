...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
        ...
        <div class="row">
          <div class="col-sm-12 col-md-7 col-lg-6 offset-lg-1">
            ...
            <!-- START: 00-atomer-07-tekst-03-avsnitt -->
            <p class="a-fontBold">2. Hvis du mener dette er en side du skal ha tilgang til kan du ringe brukerservice på <a href="#" class="a-linkArea a-fontBold text-nowrap">75 00 60 00</a>. For å finne feilen raskere er det fint om du noterer og oss denne informasjonen:
              </p>
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Feilside 403",
      "patternPartial": "sider-portal-feilside-403",
