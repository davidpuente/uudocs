...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging -->
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6 offset-lg-3 a-articleSearch">
          ...
          <div class="form-group a-form-group  a-form-group-large  ">
            ...
            <label class="a-form-label  sr-only  " for="text-input-generic">Søk etter hjelp og annet innhold</label>

            <div class="a-form-group-items input-group   ">

              <input class="form-control  
         a-hasButton  " type="text" placeholder="Søk etter hjelp og annet innhold" name="input-field" data-val="true" id="text-input-generic">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 pb-3">
            ...
            <article class="a-linkArticle">
              ...
              <h2>
                <!-- START: 00-atomer-02-lenker-00-link -->
                <a href="/patterns/04-sider-infoportal-20-navigasjonssider-80-navigasjonstrekkspill/04-sider-infoportal-20-navigasjonssider-80-navigasjonstrekkspill.html" class="a-link-title ">
  Logg inn
              ...
              <p>Altinn har flere innloggingsmetoder. 98% av alle brukere benytter seg av en avinnloggingsmetodene til ID-porten som har egne hjelpesider. Men altinn har også egneinnloggingsmetoder for enkelte brukere med særegne behov.</p>
            </article>
  ...
  Velge aktør
              ...
              <p>Har du plikter og rettigheter til andre enn bare deg selv som privatperson i altinn? Da må du velge den aktøren du skal representere etter innlogging.</p>
            </article>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-32-temaside-v-hjelp-innlogging -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Temaside V Hjelp Innlogging",
      "patternPartial": "sider-infoportal-temaside-v-hjelp-innlogging",
