...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-31-temaside-v-arbeidsforhold -->
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 pb-3">
            ...
            <div class="a-list-container a-list-2col clearfix mb-5">
              <ul class="a-list   a-list-2col a-list-noIcon ">
                  ...
                  <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Hvilke plikter gir det meg å ha ansatte
                  ...
                  <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Ansattelse av utenlandske arbeidstakere
                  ...
                  <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Hvilke arbeidstid kan vi avtale
                  ...
                  <a href="/patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Dekning etter regning - Utgiftsrefusjon
                  ...
                  <a href="/patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Innrapportering av arbeids- og inntektsopplysninger
                  ...
                  <a href="/patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
                        ...
                        Honorar til tjenesteytende næringsdrivende
  ...
  Permitering
              ...
              <p>En del foretak har behov for å permitere ansatte i korte eller lengre perioder. Det er en del kritterier som skal oppfylles for at permiteringen er lovlig. Her finner du en oversikt over hva som skal til og hvordan dere går frem.</p>
            </article>
            ...
            <!-- START: 00-atomer-07-tekst-10-seksjonstittel -->
            <h2 class="a-h3">Opphør av arbeidsforhold
            </h2>
            ...
            <!-- START: 00-atomer-07-tekst-10-seksjonstittel -->
            <h2 class="a-h3">Sykdom og skader
            </h2>
            ...
            <!-- START: 01-molekyler-05-lister-00-liste-unummerert JS doc: selectableCheckbox.js -->
            <div class="a-list-container a-list-2col clearfix mb-5">
              <ul class="a-list   a-list-1col a-list-noIcon ">
                <li class="a-dotted a-clickable a-list-hasRowLink">
                  <a href="/patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="a-list-rowLink">
                    <div class="row ">
                      <div class="col">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-31-temaside-v-arbeidsforhold -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Temaside V Arbeidsforhold",
      "patternPartial": "sider-infoportal-temaside-v-arbeidsforhold",
