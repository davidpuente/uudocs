    ...
    <span class="primary-collapse-text">
      Krav til innsender
                ...
                <div id="accordionSmallItem3" class="a-collapseContent collapse " role="tabpanel" aria-labelledby="collapseTitle3">
                  <p>For å fylle ut dette skjemaet trenger du Altinn-rollen Regnskapsmedarbeider, Revisormedarbeider eller Regnskapsfører uten signeringsrett. Signering krever rollen Begrenset signeringsrettighet eller Regnskapsfører med signeringsrett.
                    Om selskapet er revisorpliktig kreves rollen Revisorrettighet eller Ansvarlig revisor.</p>
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternBreadcrumb": {
        ...
        "patternSubtype": "skjemaartikkel"
      },
      "patternExtension": "mustache",
      "patternName": "Artikkel Skjema V Selskapsoppgave For Deltakerliknet Selskap",
      "patternPartial": "sider-infoportal-artikkel-skjema-v-selskapsoppgave-for-deltakerliknet-selskap",
