  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Brukes når passord skal endres. Feilmelding kommer om passord ikke tilfredstiller reglene. Bruker kan velge å vise passord i klartekst, og skjule det igjen. Etter 15 sekunder skjules passordet automatisk om det er valgt å vise det i klartekst.</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "forms"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Passord Input",
      "patternPartial": "atomer-♺-passord-input",
