  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Samme som tekst input, men label er skjult med sr-only (kun synlig for skjermlesere).\nBrukt i attraktivitetsprojektet, så arkiveres til den er nødvendig.</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "forms"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Tekst Input Hjelpetekst",
      "patternPartial": "atomer-♺-tekst-input-hjelpetekst",
