...
<body class="a-bgWhite" id="top">
  <!-- START: 04-sider-infoportal-20-navigasjonssider-80-navigasjonstrekkspill -->
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6 offset-lg-3 a-articleSearch">
          ...
          <div class="form-group a-form-group  a-form-group-large  ">
            ...
            <label class="a-form-label  sr-only  " for="help-search2">Søk etter hjelp og annet innhold</label>

            <div class="a-form-group-items input-group   ">

              <input class="form-control a-hasButton 
         a-hasButton  " type="text" placeholder="Søk etter hjelp og annet innhold" name="input-field" data-val="true" id="help-search2">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1 pb-3">
            ...
            <p class="a-leadText " id="leadText">Altinn har flere innloggingsmetoder. 98% av alle brukere benytter seg av en av innloggingsmetodene til ID-porten som har egne hjelpesider. Men altinn har også egne innloggingsmetoder for enkelte brukere med særegne behov.</p>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-10 offset-lg-1">
            ...
            <h2 class="">Spørsmål du kanskje har om aktørvalg:
            </h2>
    ...
    Hvorfor får jeg ikke opp aktørvalg?
</a>
  ...
  Trinn for trinn uten å logge inn
    ...
    Hvordan ser jeg hvor det er nye meldinger?
</a>
    ...
    Hvordan kan jeg søke i meldinger til flere aktører samtidig?
</a>
    ...
    Hvordan går jeg frem for å få tilgang til foretaket jeg jobber i?
</a>
    ...
    Hvordan fjerner jeg en aktør fra aktørlisten?
</a>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-infoportal-20-navigasjonssider-80-navigasjonstrekkspill -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Navigasjonstrekkspill",
      "patternPartial": "sider-infoportal-navigasjonstrekkspill",
