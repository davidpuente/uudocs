...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  med en lenke som står i løpende tekst
            ...
            <!-- START: 00-atomer-07-tekst-03-avsnitt -->
            <p class="">Etter registrering i mva-registeret får du tilbake merverdiavgiften på varer og tjenester som kjøpes til bedriften (inngående merverdiavgift). Hvis inngående avgift (avgift på varer du kjøper) er større enn utgående avgift (avgift på varer
              du selger), vil du altså få penger tilbake. </br>
              </br> Du kan også kreve å få tilbake merverdiavgift på anskaffelser du gjorde før du ble registrert i mva-registeret - inntil tre år tilbake i tid. Forutsetningen for dette er at varen ikke er videresolgt uten merverdiavgift, og at den var til
              bruk i den avgiftspliktige virksomheten. Kravet kan fremstilles ved å krysse av for at du har foretatt anskaffelser når du registrerer deg i mva-registeret. </p>
...
<!-- END: 04-sider-infoportal-30-artikkel-11-artikkel-v-mva -->
  ...
  {"cssEnabled":false,"patternLineageExists":true,"patternLineages":[{"lineagePattern":"maler-infoportal-artikkel-v-mva","lineagePath":"../../patterns/03-maler-infoportal-30-artikkel-_11-artikkel-v-mva\\03-maler-infoportal-30-artikkel-_11-artikkel-v-mva.html"}],"lineage":[{"lineagePattern":"maler-infoportal-artikkel-v-mva","lineagePath":"../../patterns/03-maler-infoportal-30-artikkel-_11-artikkel-v-mva\\03-maler-infoportal-30-artikkel-_11-artikkel-v-mva.html"}],"patternLineageRExists":false,"patternLineagesR":[],"lineageR":[],"patternLineageEExists":true,"patternDesc":"","patternBreadcrumb":{"patternType":"sider-infoportal","patternSubtype":"artikkel"},"patternExtension":"mustache","patternName":"Artikkel V Mva","patternPartial":"sider-infoportal-artikkel-v-mva","patternState":"complete","patternEngineName":"mustache","extraOutput":{}}
</script>
