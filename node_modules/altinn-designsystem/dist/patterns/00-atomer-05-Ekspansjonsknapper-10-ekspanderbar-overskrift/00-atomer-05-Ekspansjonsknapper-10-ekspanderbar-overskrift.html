  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Brukes til mindre prioritert innhold som må være tilgjengelig, men som ikke skal ta fokus bort fra resten av innholdet. Kan settes sammen til et trekkspill, se\n[trekkspill.mustache]</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "Ekspansjonsknapper"
      },
      "patternExtension": "mustache",
      "patternName": "Ekspanderbar Overskrift",
      "patternPartial": "atomer-ekspanderbar-overskrift",
