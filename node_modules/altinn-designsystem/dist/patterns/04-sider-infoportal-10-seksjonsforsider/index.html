...
<div id="viewall-sider-infoportal-seksjonsforsider" class="sg-pattern-category">
  <h2 class="sg-pattern-category-title"><a href="../../patterns/04-sider-infoportal-10-seksjonsforsider\index.html" class="patternLink" data-patternpartial="viewall-sider-infoportal-seksjonsforsider">seksjonsforsider</a></h2>
...
<div id="sider-infoportal-seksjonsforside-v-starteogdrive" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive\04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="patternLink" data-patternpartial="sider-infoportal-seksjonsforside-v-starteogdrive" title="Link to Pattern">
          Seksjonsforside V Starteogdrive
            <span class="sg-pattern-state needsrevalidation">needsrevalidation</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-infoportal-seksjonsforside-v-starteogdrive" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-infoportal-seksjonsforside-v-starteogdrive" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-infoportal-seksjonsforside-v-starteogdrive">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive -->
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <section id="content" tabindex="-1">
    ...
    <div class="container-fluid">
      ...
      <div class="jumbotron jumbotron-fluid a-jumbotron a-jumbotron-top a-jumbotron-light" style="background-color: #fff;  background-image: url('../../images/illustrasjon_starte_og_drive.svg') ">
        <div class="container">
          <div class="row">
            <div class="  col-md-8 offset-md-0 col-lg-6 offset-lg-1 col-xl-5 offset-xl-1">
              ...
              <!-- START: 00-atomer-02-lenker-00-link -->
              <a href="/patterns/04-sider-infoportal-20-navigasjonssider-31-temaside-v-starte/04-sider-infoportal-20-navigasjonssider-31-temaside-v-starte.html" class="a-linkFeatured a-link-large" data-parent="#accordion">
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-7">
                      ...
                      <div class="a-list-container a-list-large pb-2">
                        <ul class="a-list  a-list-large   a-list-noIcon a-list-large ">
                          <li class="a-dotted a-clickable a-list-hasRowLink">
                            <a href="/patterns/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive/04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                                  ...
                                  Guide: Dine plikter som arbeidsgiver
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
                    ...
                    <div class="col-lg-4 offset-lg-1 col-xl-3 offset-xl-2 hidden-md-down a-collapseContent-img">
                      ...
                      <img src="../../images/illustrasjon_arbeidsforhold_sirkel.svg" alt="Illustrasjon" />
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-7">
                      ...
                      <div class="a-list-container a-list-large pb-2">
                        <ul class="a-list  a-list-large   a-list-noIcon a-list-large ">
                          <li class="a-dotted a-clickable a-list-hasRowLink">
                            <a href="/patterns/04-sider-infoportal-30-artikkel-11-artikkel-v-mva/04-sider-infoportal-30-artikkel-11-artikkel-v-mva.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                                  <!-- START: 01-molekyler-05-lister-_00-liste-innhold -->
                            ...
                            <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                                  ...
                                  Guide: Hvem er regnskapspliktig?
                            ...
                            <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                                  ...
                                  Tips: Innlevering av selvangivelse
                ...
                <div class="a-collapseContent-inside">
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-7">
                      <!-- START: 01-molekyler-05-lister-00-liste-unummerert JS doc: selectableCheckbox.js -->
                      <div class="a-list-container a-list-large pb-2">
                        <ul class="a-list   a-list-noIcon a-list-large ">
                          <li class="a-dotted a-clickable a-list-hasRowLink">
                            <a href="/patterns/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap/04-sider-infoportal-30-artikkel-16-artikkel-v-regnskap.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                ...
                <div class="a-collapseContent-inside">
                  ...
                  <div class="row">
                    <div class="col-md-12 col-lg-7">
                            ...
                            <a href="/patterns/04-sider-infoportal-20-navigasjonssider-40-temaside-filter-v-stotteordninger/04-sider-infoportal-20-navigasjonssider-40-temaside-filter-v-stotteordninger.html" class="a-list-rowLink">
                              <div class="row ">
                                <div class="col">
                                  ...
                                  Guide: Aktuelle støtteordninger for deg
                      ...
                      <!-- START: 00-atomer-02-lenker-00-link -->
                      <a href="/patterns/04-sider-infoportal-20-navigasjonssider-40-temaside-filter-v-stotteordninger/04-sider-infoportal-20-navigasjonssider-40-temaside-filter-v-stotteordninger.html" class="a-linkFeatured a-link-large" data-parent="#accordion">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
        ...
        <div class="col-sm-12">
          ...
          <div class="a-iconText a-iconText-shadow a-iconText-background a-iconText-background--white mt-4">
            <div class="a-iconText-icon ">
              <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
              <i class="ai ai-circle-plus  a-icon "></i>
        ...
        <div class="col-lg-8 offset-lg-2 ">
          ...
          <section class="a-articleList ">
            ...
            <article class="a-linkArticle">
              ...
              <h3>
                <!-- START: 00-atomer-02-lenker-00-link -->
                <a href="/patterns/04-sider-infoportal-30-artikkel-80-artikkel-v-nyhet/04-sider-infoportal-30-artikkel-80-artikkel-v-nyhet.html" class="a-link-title " data-parent="#accordion">
  ...
  NAV endrer rapportering av refusjon
            ...
            <!-- START: 00-atomer-02-lenker-00-link -->
            <a href="/patterns/04-sider-infoportal-20-navigasjonssider-60-arkiv-v-nyhetsarkiv/04-sider-infoportal-20-navigasjonssider-60-arkiv-v-nyhetsarkiv.html" class="a-linkFeatured " data-parent="#accordion">
  Vis alle nyheter
...
<!-- END: 04-sider-infoportal-10-seksjonsforsider-30-seksjonsforside-v-starteogdrive -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-infoportal-seksjonsforside-v-starteogdrive" class="sg-pattern-data">
  ...
  {"patternPartial":"viewall-sider-infoportal-seksjonsforsider"}
</script>
