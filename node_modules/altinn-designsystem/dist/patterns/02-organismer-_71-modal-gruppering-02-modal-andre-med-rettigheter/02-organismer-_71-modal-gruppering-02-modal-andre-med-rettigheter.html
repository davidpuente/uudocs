...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
    ...
    <span class="sr-only">Vis mer info</span>
        ...
        <div id="popoverWithIconToggle" style="display: none">
          ...
          <a href="http://www.altinn.no" class=" " data-toggle="collapse" data-target="#departement-filter" aria-controls="departement-filter">
  med en lenke som står i løpende tekst
      ...
      <div class="col-xl-12 mt-2">
        ...
        <button type="submit" class="a-btn a-btn-success mb-0" data-target="departement-filter">
    ...
    Fullfør
      ...
      <div class="col-xl-12 mt-2">
        <!-- START: 00-atomer-02-lenker-00-link -->
        <a href="/patterns/04-sider-infoportal-01-forside-00-forside/04-sider-infoportal-01-forside-00-forside.html" class=" " data-toggle="collapse" data-target="#departement-filter" aria-controls="departement-filter">
    ...
    <div class="row">
      <div class="col-12 col-lg-6 mb-1">
        ...
        <div class="form-group a-form-group  ">
          ...
          <label class="a-form-label  sr-only  " for="text-input-generic">Søk</label>
    ...
    <div class="row">
      <div class="col-12">
        <div class="mt-1 mb-2">
                ...
                <div class="row">
                  <div class="col">
                    <h2 class="a-collapseHeader a-h3 a-collapseHeader-with-actions">
                      <a data-toggle="collapse" href="#" data-target="#exp-list-1" aria-expanded="" aria-controls="exp-list-1" class="a-collapse-title a-collapse-title--absolute no-decoration  collapsed ">
          ...
          <div id="exp-list-1" class="a-collapseContent collapse " aria-expanded="false" role="">
    ...
    <div class="row">
      <div class="col-12 col-md-8 col-xl-6">
        ...
        <div class="form-group a-form-group  ">
          ...
          <label class="a-form-label  sr-only  " for="text-input-delegering-epost">Epost:</label>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <div class="modal-body a-modal-body">
    ...
    <div id="exp-list" class="a-collapseContent collapse " aria-expanded="false">
  ...
  <div class="modal-body a-modal-body">
              ...
              <div class="col-12 col-lg-7">
                ...
                <div class="form-group a-form-group  ">
                  ...
                  <div class="a-form-group-items input-group   ">
                    ...
                    <input class="form-control  
         " type="text" placeholder="11 siffer" name="input-field" data-val="true" id="text-fnr-brukernavn" required data-val-regex="Personnummer må bestå av 11 siffer." data-val-regex-pattern="">
                ...
                <div class="mt-1">
                  ...
                  <div class="form-group a-form-group  ">
                    ...
                    <div class="a-form-group-items input-group   ">
                      ...
                      <input class="form-control  
         " type="text" name="input-field" data-val="true" id="text-etternavn" required data-val-regex="Personnummer må bestå av 11 siffer." data-val-regex-pattern="">
    ...
    Neste
        ...
        <div class="tab-pane " id="enterprise" role="tabpanel">
         ...
         " type="text" name="input-field" data-val="true" id="text-orgno" required>
                ...
                <div class="mt-1">
                  ...
                  <div class="form-group a-form-group  ">
                    ...
                    <div class="a-form-group-items input-group   ">
                      ...
                      <input class="form-control  
         " type="text" placeholder="Min. 4 første tegn" name="input-field" data-val="true" id="text-bedriftnavn" required>
              ...
              <div class="col-12 col-lg-7">
                ...
                <div class="form-group a-form-group  ">
                  ...
                  <div class="a-form-group-items input-group   ">
                    ...
                    <input class="form-control  
         " type="text" name="input-field" data-val="true" id="text-enterprise-brukernavn" required>
                ...
                <div class="mt-1">
                  ...
                  <div class="form-group a-form-group  ">
                    ...
                    <div class="a-form-group-items input-group   ">
                      ...
                      <input class="form-control a-js-orgNr 
         " type="text" name="input-field" data-val="true" id="text-enterpriseuser-orgno" required>
  ...
  <div class="modal-body a-modal-body">
    <div class="row">
      ...
      <div class="col-12 col-md-4 mb-1 mb-md-0">
        <!-- START: 00-atomer-03-knapper-10-knapp -->
        <button class="a-btn-link " data-target="departement-filter">
  <span>
    Avbryt
  </span>
</button>
      ...
      <div class="col-12 col-md-6">
        ...
        <div class="form-group a-form-group  ">
          ...
          <label class="a-form-label  " for="text-input-opprett-rolle">Rollenavn:</label>

          <div class="a-form-group-items input-group   ">

            <input class="form-control  
         " type="text" name="input-field" data-val="true" id="text-input-opprett-rolle">
    ...
    <div class="row">
      <div class="col-12 col-md-6">
        ...
        <div class="form-group a-form-group  ">
          ...
          <label class="a-form-label  sr-only  " for="text-input-find-13">Legg til rettigheter:</label>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
    ...
    <div class="row">
      <div class="col mt-3">
        <!-- START: 00-atomer-03-knapper-10-knapp -->
        <button class="a-btn a-btn-success mr-2 mr-2" data-target="departement-filter">
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternLineages": [{
        ...
        "lineagePattern": "organismer-roller-tjenesteoversikt",
        "lineagePath": "../../patterns/02-organismer-70-Modal-innhold-_92-roller-tjenesteoversikt\\02-organismer-70-Modal-innhold-_92-roller-tjenesteoversikt.html",
        "lineageState": "indesignreview"
      }, {
      ...
      "patternDesc": "<p>Modal-gruppering for andre med rettigheter</p>\n",
      "patternBreadcrumb": {
        "patternType": "organismer",
        "patternSubtype": "modal-gruppering"
      },
      "patternExtension": "mustache",
      "patternName": "Modal Andre Med Rettigheter",
      "patternPartial": "organismer-modal-andre-med-rettigheter",
