            ...
            <div class="a-collapsePanel-body collapse in" role="tabpanel" aria-labelledby="" id="accordionItem1">
              <div class="card-block a-text a-collapsePanel-body-content a-collapseContent-delay">
                ...
                <p>Skal du fakturere kunder fremover så er det viktig å gjøre seg opp et regnestykke for om det er nødvendig å anskaffe seg en regnskapsfører eller revisor. Det er absolutt ikke et krav til bruk av regnskapsfører eller revisor, men du må
                  vurdere det ut i fra hvor mye du skal fakturere for og hvor mye tid det tar fra deg til å gjøre jobben din. Det finnes flere gratisprogrammer man kan bruke. Uansett hva du ender opp med, husk bare at det er noen krav til hvordan en faktura
                  skal se ut og hva den skal inneholde.Hva skal stå på salgsdokumentene?</p>
                ...
                <p>Når inntektene dine er større enn utgiftene/kostnadene, blir det et overskudd. Det er dette du bruker som grunnlaget for beregning av skatt. Dette anses ikke som lønn. Det gjelder forøvrig hvis du har en ektefelle som gjør et stykke arbeid
                  for deg også, utbetaling til ektefelle er heller ikke lønn.Lønn og skatt for enkeltpersonforetak</p>
              </div>
            </div>
          </div>
