  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Innholdet til modal klientdelegering for kvitteringsside.</p>\n",
      "patternBreadcrumb": {
        "patternType": "organismer",
        "patternSubtype": "Modal-innhold"
      },
      "patternExtension": "mustache",
      "patternName": "Klientdelegering Ferdig",
      "patternPartial": "organismer-klientdelegering-ferdig",
