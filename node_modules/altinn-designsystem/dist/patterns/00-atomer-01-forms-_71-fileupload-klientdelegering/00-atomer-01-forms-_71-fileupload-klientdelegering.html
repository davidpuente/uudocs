...
<body class="" id="top">
  ...
  <input  class="a-js-fileInputChangeHandler sr-only" type="file" id="customFileuploadId">
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Custom input type=file with javascript for displaying the selected file. Only supports selection of 1 file. Can be displayed with or without list</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "forms"
      },
      "patternExtension": "mustache",
      "patternName": "Fileupload Klientdelegering",
      "patternPartial": "atomer-fileupload-klientdelegering",
