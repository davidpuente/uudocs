...
<body class="" id="top">
  <!-- START: 04-sider-portal-50-innboks-02-videresend-pa-epost -->
                    ...
                    <div class="modal-header a-modal-header">
                      ...
                      <div class="a-iconText a-iconText-background a-iconText-large ">
                        <div class="a-iconText-icon ">
                          <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                          <i class="reg reg-forward-msg  a-icon "></i>


                          <!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
                        </div>
                        <h1 class="a-iconText-text mb-0">
                          <span class="a-iconText-text-large">Videresend på e-post  </span>
                        </h1>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <h2 class="a-h3 mb-1 mb-md-3">
                            Velg hvem du vil videresend til
                          </h2>
                        </div>
                        <div class="col-12 col-md-11">
                          ...
                          <div class="form-group a-form-group  ">
                            ...
                            <label class="a-form-label  " for="emailFieldID">E-post (hvis flere, skill med semikolon)</label>

                            <div class="a-form-group-items input-group   ">

                              <input class="form-control  
         " type="text" placeholder="Skriv inn en eller flere e-postadresser" name="input-field" data-val="true" id="emailFieldID" data-search-algorithm="show-and-highlight" data-search-target="employee-table">
                          ...
                          <div class="form-group a-form-group ">
                            <label for="text-input-generic" class="a-form-label">Personlig melding (valgfritt)</label>
                            <textarea class="form-control a-textarea" rows="3" placeholder="Gi en beskjed til den du videresender til..." name="input-field" id="text-input-generic"></textarea>
                          </div>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 04-sider-portal-50-innboks-02-videresend-pa-epost -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Videresend Pa Epost",
      "patternPartial": "sider-portal-videresend-pa-epost",
