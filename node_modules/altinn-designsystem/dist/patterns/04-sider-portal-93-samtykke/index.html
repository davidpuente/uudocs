...
<div id="viewall-sider-portal-samtykke" class="sg-pattern-category">
  <h2 class="sg-pattern-category-title"><a href="../../patterns/04-sider-portal-93-samtykke\index.html" class="patternLink" data-patternpartial="viewall-sider-portal-samtykke">samtykke</a></h2>
...
<div id="sider-portal-se-og-fjern-samtykke" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-portal-93-samtykke-00-se-og-fjern-samtykke\04-sider-portal-93-samtykke-00-se-og-fjern-samtykke.html" class="patternLink" data-patternpartial="sider-portal-se-og-fjern-samtykke" title="Link to Pattern">
          Se Og Fjern Samtykke
            <span class="sg-pattern-state indesignreview">indesignreview</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-portal-se-og-fjern-samtykke" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-portal-se-og-fjern-samtykke" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-portal-se-og-fjern-samtykke">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-portal-93-samtykke-00-se-og-fjern-samtykke -->
                  ...
                  <div class="modal-header a-modal-header">
                    ...
                    <div class="a-iconText a-iconText-background a-iconText-large ">
                      <div class="a-iconText-icon ">
                        <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                        <i class="ai ai-read  a-icon "></i>


                        <!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
                      </div>
                      <h1 class="a-iconText-text mb-0">
                        <span class="a-iconText-text-large">Se og fjern samtykke  </span>
                      </h1>
                    </div>
    ...
    <span>
      Fjern samtykke
                        ...
                        <div id="sampleIdPopoverButtoinLink" class="hidden-xs-up">
                          <div class="pb-1">Samtykke vil bli slettet</div>
...
<!-- END: 04-sider-portal-93-samtykke-00-se-og-fjern-samtykke -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-portal-se-og-fjern-samtykke" class="sg-pattern-data">
    
  </script>
</div><!--end .sg-pattern-->
<div id="sider-portal-gi-samtykke" class="sg-pattern">
  <div class="sg-pattern-head">
    <h3 class="sg-pattern-title">
      <a href="../../patterns/04-sider-portal-93-samtykke-01-gi-samtykke\04-sider-portal-93-samtykke-01-gi-samtykke.html" class="patternLink" data-patternpartial="sider-portal-gi-samtykke" title="Link to Pattern">
          Gi Samtykke
            <span class="sg-pattern-state indesignreview">indesignreview</span>
      </a>
    </h3>
    <div class="sg-pattern-breadcrumb"></div>
    <a href="#" data-patternpartial="sider-portal-gi-samtykke" title="View Pattern Info" id="sg-pattern-extra-toggle-sider-portal-gi-samtykke" class="sg-pattern-extra-toggle"><span>&#9660;</span></a>
  </div>
  <div class="sg-pattern-extra" id="sg-pattern-extra-sider-portal-gi-samtykke">
    
  </div>
  <div class="sg-pattern-example">
    <!-- START: 04-sider-portal-93-samtykke-01-gi-samtykke -->
<!-- START: 03-maler-portal-91-modal-01-modal -->
<div class="a-modal fade modal show " tabindex="-1" role="dialog" style="display: block">
  <div class="modal-dialog modal-lg" role="document">
    <div class="container a-p-static">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <ul id="secondary-nav" class="nav nav-pills a-header-options">
                    <li class="nav-item">
                      <!-- START: 00-atomer-07-tekst-40-innlogget -->
                      <button class="nav-link dropdown-toggle a-personSwitcher subheader-dark" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  Logg ut
                          ...
                          <!-- START: 00-atomer-03-knapper-10-knapp -->
                          <button type="button" class="a-btn mb-5 mt-1 ">
            ...
            <div class="a-page a-current-page">
              <div class="modalPage">
                <div class="modal-content">
                  ...
                  <div class="modal-header a-modal-header">
                    <!-- START: 01-molekyler-00-tekst-30-ikon-tekst -->
                    <div class="a-iconText a-iconText-background a-iconText-background--white a-iconText-large ">
                      <div class="a-iconText-icon ">
                        <!-- START: 00-atomer-09-bilder-og-media-15-ikon -->
                      ...
                      <h1 class="a-iconText-text mb-0">
                        <span class="a-iconText-text-large">Samtykke til bruk av dine data  </span>
                      </h1>
                    </div>
                  ...
                  <div class="modal-body a-modal-body">
                    <div class="row">
                      <div class="col">
                        <h2 class="a-fontSizeS a-fontBold">
                          Altinn1 ANS ønsker midlertidig innsyn
                        </h2>
                        <p class="a-fontSizeXS mb-1">
                          Velkommen til samtykkeløsningen
                        </p>
    ...
    <span class="primary-collapse-text">
      Denne teksten kan man trykke på for å se utvidet informasjon om et tema
                    ...
                    <div class="row">
                      <div class="col">
                        <p class="mt-2 a-fontBold a-fontSizeXS mb-1">
                          Dette innsynet er tidsavgrenset og vil gå ut 2099-01-01 23:59:59
                        </p>
                      </div>
                    </div>
                    <div class="row">
...
<!-- END: 04-sider-portal-93-samtykke-01-gi-samtykke -->
  </div>
  <script type="text/json" id="sg-pattern-data-sider-portal-gi-samtykke" class="sg-pattern-data">
  ...
  {"patternPartial":"viewall-sider-portal-samtykke"}
</script>
