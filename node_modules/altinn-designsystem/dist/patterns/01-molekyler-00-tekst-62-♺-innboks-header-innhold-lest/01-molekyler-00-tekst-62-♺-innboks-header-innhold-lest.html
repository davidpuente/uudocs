  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Header innhold for ekspanderbar panel for innboks lister for en lest melding</p>\n",
      "patternBreadcrumb": {
        "patternType": "molekyler",
        "patternSubtype": "tekst"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Innboks Header Innhold Lest",
      "patternPartial": "molekyler-♺-innboks-header-innhold-lest",
