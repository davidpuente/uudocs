  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Header innhold for ekspanderbar panel for innboks lister for en melding som er videresendt. Trenger å ha container med a-inboxCompact rundt seg for å få riktig høyde.</p>\n",
      "patternBreadcrumb": {
        "patternType": "molekyler",
        "patternSubtype": "tekst"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Innboks Header Innhold Kompakt",
      "patternPartial": "molekyler-♺-innboks-header-innhold-kompakt",
