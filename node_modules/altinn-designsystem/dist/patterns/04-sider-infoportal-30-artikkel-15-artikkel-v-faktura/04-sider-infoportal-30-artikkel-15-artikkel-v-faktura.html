      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-8 offset-lg-2 a-text epi-wysiwyg pt-2 pt-lg-3">
            ...
            <p>Har du sendt ut feil faktura, eller ønsker å endre en utsendt faktura av andre grunner, kan du lage en kreditnota. En kreditnota brukes for å korrigere tidligere faktura. Det er samme krav til dokumentasjon av en kreditnota, som det er til
              en faktura.</p>
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Artikkel V Faktura",
      "patternPartial": "sider-infoportal-artikkel-v-faktura",
