...
<body class="a-bgBlueLight" id="top">
  <!-- START: 04-sider-portal-50-innboks-_20-innboks-ansatte -->
  <!-- START: 03-maler-portal-50-innboks-_20-innboks-ansatte -->
  <div class="a-page">
    ...
    <span class="a-btn-icon-text ">
                ...
                <a href="#" data-toggle="collapse" data-target="#accordionItem1" aria-expanded="false" aria-controls="accordionItem1" data-parent="#accordion">
                  ...
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    ...
                    <div class="a-iconText-text">
                      ...
                      <span class="a-iconText-text-large">A-meldingen november 2016 — Mangelfull rapportering (A03)  </span>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 a-p-x9-xl">
          <!-- START: 00-atomer-02-lenker-00-link -->
          <a href="/patterns/04-sider-portal-50-innboks-_20-innboks-ansatte/04-sider-portal-50-innboks-_20-innboks-ansatte.html" class=" ">
  Vis arkiv
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <span class="a-box-button-text">
    ...
    <span class="a-box-button-name">
      <span class="sr-only">
        Are Sverre Gjertin urkegjerde Halland
      </span>
      <span class="a-js-inner-text" aria-hidden="true">
        Are Sverre Gjertin urkegjerde Halland
      </span>
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 03-maler-portal-50-innboks-_20-innboks-ansatte -->


  <!-- END: 04-sider-portal-50-innboks-_20-innboks-ansatte -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Innboks Ansatte",
      "patternPartial": "sider-portal-innboks-ansatte",
