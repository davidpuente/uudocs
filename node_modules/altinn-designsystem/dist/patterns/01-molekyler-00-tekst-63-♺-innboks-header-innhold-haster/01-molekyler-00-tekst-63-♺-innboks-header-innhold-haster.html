  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Header innhold for ekspanderbar panel for innboks lister for en melding som haster. Stylingen styres av css klassen a-msgUrgent</p>\n",
      "patternBreadcrumb": {
        "patternType": "molekyler",
        "patternSubtype": "tekst"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Innboks Header Innhold Haster",
      "patternPartial": "molekyler-♺-innboks-header-innhold-haster",
