...
<body class="a-bgBlueLight" id="top">
  <!-- START: 04-sider-portal-50-innboks-_10-innboks-mva-og-skatt -->
  <!-- START: 03-maler-portal-50-innboks-_10-innboks-mva-og-skatt -->
  <div class="a-page">
    ...
    <span class="a-btn-icon-text ">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 mt-4  a-p-x9-xl">
          ...
          <p>
            Du er enda ikke i mva-registeret. Det skjer idet du passerer en omsetning på 50.000 i løpet av en 12-månedersperiode. Du skal hente inn merverdiavgift fra og med det salget som gjør at du passerer grensen. Fortsatt usikker? <a href="#">Når skal jeg i merverdiavgiftregisteret?</a>
          </p>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12 mt-4  a-p-x9-xl">
          ...
          <p>
            For enkeltpersonforetaket ditt skatter du som privatperson. Hvert kvartal utskriver vi forskuddsskatt basert på inntektene som innrapporteres fra regnskapssystemet ditt. under ser du en oversikt over hva du kan forvente deg i skatt neste termin.</a>
          </p>
        </div>
        <!-- END .col-... -->
      </div>
        ...
        <div class="col-sm-12 col-lg-12 mb-1 ">
          ...
          <div id="accordion" class="a-panelAccordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="card a-accordion-card a-collapsePanel {a-inbox-messageList}">
                ...
                <a href="#" data-toggle="collapse" data-target="#accordionItem1" aria-expanded="false" aria-controls="accordionItem1" data-parent="#accordion">
                  ...
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    ...
                    <div class="a-iconText-text">
                      ...
                      <span class="a-iconText-text-large">Forskuddsskatt juli – september 2016  </span>
                    </div>
                  </div>
              ...
              <div class="a-collapsePanel-body collapse" role="tabpanel" aria-labelledby="" id="accordionItem1">
              ...
              <div class="card-header a-js-index-heading a-collapsePanel-heading collapsed" role="tab">
                <a href="#" data-toggle="collapse" data-target="#accordionItem2" aria-expanded="false" aria-controls="accordionItem2" data-parent="#accordion">
                  ...
                  <div class="a-iconText a-iconText-shadow a-collapseBtn collapsed ">
                    ...
                    <div class="a-iconText-text">
                      <span class="a-iconText-text-small">Skatteetaten</span>
                      <span class="a-iconText-text-large">Forskuddsskatt april – juni 2016 <span class="a-dot a-dot-red">Purring!</span> </span>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-12  a-p-x9-xl">
          <!-- START: 00-atomer-02-lenker-00-link -->
          <a href="/patterns/04-sider-portal-50-innboks-_10-innboks-mva-og-skatt/04-sider-portal-50-innboks-_10-innboks-mva-og-skatt.html" class=" ">
  Vis arkiv
...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  <!-- END: 03-maler-portal-50-innboks-_10-innboks-mva-og-skatt -->


  <!-- END: 04-sider-portal-50-innboks-_10-innboks-mva-og-skatt -->
  <!-- DO NOT REMOVE -->
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Innboks Mva Og Skatt",
      "patternPartial": "sider-portal-innboks-mva-og-skatt",
