  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Når man lenker til en ekstern side, altså en side utenfor altinn.no, skal det vises en pil opp ved siden av lenketeksten. Dette oppdages automatisk (dersom man refererer til &quot;http://&quot; utenfor altinn), så man trenger ikke legge på denne pilen manuelt.</p>\n",
      "patternBreadcrumb": {
        "patternType": "atomer",
        "patternSubtype": "lenker"
      },
      "patternExtension": "mustache",
      "patternName": "♺ Link Ekstern",
      "patternPartial": "atomer-♺-link-ekstern",
