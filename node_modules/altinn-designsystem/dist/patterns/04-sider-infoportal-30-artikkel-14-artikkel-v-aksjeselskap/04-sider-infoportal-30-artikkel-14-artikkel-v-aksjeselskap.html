...
<!-- END: 00-atomer-09-bilder-og-media-15-ikon -->
  ...
  med en lenke som står i løpende tekst
            ...
            <!-- START: 00-atomer-07-tekst-03-avsnitt -->
            <p class="">Merverdiavgift (mva.) er en omsetningsavgift på varer og tjenester. Enkelte varer og tjenester er unntatt fra mva. eller har reduserte satser. Et aksjeselskap vil være merverdiomsetningspliktig på lik linje med andre næringsdrivende (lenke
              til mva.).</p>
  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternName": "Artikkel V Aksjeselskap",
      "patternPartial": "sider-infoportal-artikkel-v-aksjeselskap",
