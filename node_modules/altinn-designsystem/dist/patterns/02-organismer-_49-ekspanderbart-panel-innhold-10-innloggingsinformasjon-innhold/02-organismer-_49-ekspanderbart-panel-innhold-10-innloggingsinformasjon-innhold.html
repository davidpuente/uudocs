  ...
  <script type="text/json" id="sg-pattern-data-footer" class="sg-pattern-data">
    {
      ...
      "patternDesc": "<p>Innhold til ekspanderbart panel for innloggingsinformasjon.</p>\n",
      "patternBreadcrumb": {
        "patternType": "organismer",
        "patternSubtype": "ekspanderbart-panel-innhold"
      },
      "patternExtension": "mustache",
      "patternName": "Innloggingsinformasjon Innhold",
      "patternPartial": "organismer-innloggingsinformasjon-innhold",
